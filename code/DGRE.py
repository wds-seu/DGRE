...
class DGRE_BERT(nn.Module):
    def __init__(self, config):
        super(DGRE_BERT, self).__init__()
        self.config = config
    ...
    def forward(self, **params):
        ...
        entity2mention_table = params['entity2mention_table']
    ...
    def __init__(self,
        ...
        if self.use_weight:
            if self.use_basis:
                ...
                nn.init.xavier_uniform_(self.weight, dgre=nn.init.calculate_dgre('relu'))
